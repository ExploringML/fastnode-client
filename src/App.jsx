...
function useNodeFactory() {
  ...
  return (type) => {
    /* 120 px from the current top-left viewport corner (in screen coords) */
    ...
    rf.setNodes(nodes => [
      ...nodes,
      {
        ...
        id: `${nanoid(6)}`,
        type,
        position: pos,      // already in flow space
        data: { value: 0 },
      },
    ]);
  };
      ...
      <div className="w-screen h-screen flex flex-col">
        ...
        <div className="h-10 bg-gray-200 flex items-center justify-between py-6 px-4 text-sm">
          ...
          <div className="flex items-center gap-1">
            FastNode created by <a href="https://x.com/dgwyer" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">David Gwyer</a>
          </div>
        </div>
      </div>
    </>
